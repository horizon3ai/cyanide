...
from horizon3_impacket.impacket import uuid, version
from horizon3_impacket.impacket.http import AUTH_BASIC
from horizon3_impacket.impacket.examples import logger
from horizon3_impacket.impacket.examples.utils import parse_target
from horizon3_impacket.impacket.structure import parse_bitmask
from horizon3_impacket.impacket.dcerpc.v5 import transport, nspi
from horizon3_impacket.impacket.mapi_constants import PR_CONTAINER_FLAGS_VALUES, MAPI_PROPERTIES
from horizon3_impacket.impacket.dcerpc.v5.nspi import CP_TELETEX, ExchBinaryObject, \
    get_guid_from_dn, get_dn_from_guid
from horizon3_impacket.impacket.dcerpc.v5.rpch import RPC_PROXY_REMOTE_NAME_NEEDED_ERR, \
