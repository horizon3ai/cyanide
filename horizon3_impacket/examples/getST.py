...
from horizon3_impacket.impacket.krb5.asn1 import AP_REQ, AS_REP, TGS_REQ, Authenticator, TGS_REP, seq_set, seq_set_iter, PA_FOR_USER_ENC, \
    Ticket as TicketAsn1, EncTGSRepPart, PA_PAC_OPTIONS, EncTicketPart
from horizon3_impacket.impacket.krb5.ccache import CCache
from horizon3_impacket.impacket.krb5.crypto import Key, _enctype_table, _HMACMD5, _AES256CTS, Enctype
from horizon3_impacket.impacket.krb5.constants import TicketFlags, encodeFlags
from horizon3_impacket.impacket.krb5.kerberosv5 import getKerberosTGS
from horizon3_impacket.impacket.krb5.kerberosv5 import getKerberosTGT, sendReceive
from horizon3_impacket.impacket.krb5.types import Principal, KerberosTime, Ticket
from horizon3_impacket.impacket.ntlm import compute_nthash
from horizon3_impacket.impacket.winregistry import hexdump
