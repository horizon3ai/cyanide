...
from horizon3_impacket.impacket.nt_errors import STATUS_SUCCESS
from horizon3_impacket.impacket.smb import FILE_OPEN, SMB_DIALECT, SMB, SMBCommand, SMBNtCreateAndX_Parameters, SMBNtCreateAndX_Data, \
    FILE_READ_DATA, FILE_SHARE_READ, FILE_NON_DIRECTORY_FILE, FILE_WRITE_DATA, FILE_DIRECTORY_FILE
from horizon3_impacket.impacket.smb3structs import SMB2_IL_IMPERSONATION, SMB2_CREATE, SMB2_FLAGS_DFS_OPERATIONS, SMB2Create, SMB2Packet, \
...
class PIPEDREAM:
    ...
    def findSuitableShare(self):
        from horizon3_impacket.impacket.dcerpc.v5 import transport, srvs
