...
from horizon3_impacket.impacket.dcerpc.v5 import epm
from horizon3_impacket.impacket.dcerpc.v5.drsuapi import MSRPC_UUID_DRSUAPI, hDRSDomainControllerInfo, DRSBind, NTDSAPI_CLIENT_GUID, \
...
from horizon3_impacket.impacket.dcerpc.v5.lsat import MSRPC_UUID_LSAT, POLICY_LOOKUP_NAMES
from horizon3_impacket.impacket.dcerpc.v5.nrpc import MSRPC_UUID_NRPC, hDsrGetDcNameEx
from horizon3_impacket.impacket.dcerpc.v5.rpcrt import TypeSerialization1, RPC_C_AUTHN_LEVEL_PKT_INTEGRITY, RPC_C_AUTHN_LEVEL_PKT_PRIVACY
from horizon3_impacket.impacket.krb5.pac import PKERB_VALIDATION_INFO, KERB_VALIDATION_INFO, KERB_SID_AND_ATTRIBUTES, PAC_CLIENT_INFO, \
...
from horizon3_impacket.impacket.examples.utils import parse_target
...
if __name__ == '__main__':
    ...
    from horizon3_impacket.impacket.dcerpc.v5 import samr
    from horizon3_impacket.impacket.dcerpc.v5 import transport
    from horizon3_impacket.impacket.krb5.types import Principal, Ticket, KerberosTime
    from horizon3_impacket.impacket.krb5 import constants
    from horizon3_impacket.impacket.krb5.kerberosv5 import sendReceive, getKerberosTGT, getKerberosTGS, KerberosError
    from horizon3_impacket.impacket.krb5.asn1 import AS_REP, TGS_REQ, AP_REQ, TGS_REP, Authenticator, EncASRepPart, AuthorizationData, \
        AD_IF_RELEVANT, seq_set, seq_set_iter, KERB_PA_PAC_REQUEST, \
        EncTGSRepPart, ETYPE_INFO2_ENTRY
    from horizon3_impacket.impacket.krb5.crypto import Key
    from horizon3_impacket.impacket.dcerpc.v5.ndr import NDRULONG
    from horizon3_impacket.impacket.dcerpc.v5.samr import NULL, GROUP_MEMBERSHIP, SE_GROUP_MANDATORY, SE_GROUP_ENABLED_BY_DEFAULT, \
