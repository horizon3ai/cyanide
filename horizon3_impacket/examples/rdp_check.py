...
from horizon3_impacket.impacket.spnego import GSSAPI, ASN1_SEQUENCE, ASN1_OCTET_STRING, asn1decode, asn1encode
...
if __name__ == '__main__':
    ...
    from horizon3_impacket.impacket import ntlm, version
    try:
