...
from horizon3_impacket.impacket.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRPOINTER, NDRUniConformantArray, NDRUNION, NDR, NDRENUM
from horizon3_impacket.impacket.dcerpc.v5.dtypes import PUUID, DWORD, NULL, GUID, LPWSTR, BOOL, ULONG, UUID, LONGLONG, ULARGE_INTEGER, LARGE_INTEGER
from horizon3_impacket.impacket import hresult_errors, system_errors
from horizon3_impacket.impacket.structure import Structure
from horizon3_impacket.impacket.uuid import uuidtup_to_bin, string_to_bin
...
from horizon3_impacket.impacket.krb5 import crypto
