...
from horizon3_impacket.impacket.dcerpc.v5.ndr import NDRCALL, NDR, NDRSTRUCT, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniConformantVaryingArray, NDRENUM
from horizon3_impacket.impacket.dcerpc.v5.dtypes import NULL, RPC_UNICODE_STRING, ULONG, USHORT, UCHAR, LARGE_INTEGER, RPC_SID, LONG, STR, \
...
def hSamrChangePasswordUser(dce, userHandle, oldPassword, newPassword):
    ...
    from horizon3_impacket.impacket import crypto, ntlm
