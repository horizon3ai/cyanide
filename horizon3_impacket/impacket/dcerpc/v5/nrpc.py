...
from six import b
from horizon3_impacket.impacket.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRENUM, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniFixedArray, NDRUniConformantVaryingArray
from horizon3_impacket.impacket.dcerpc.v5.dtypes import WSTR, LPWSTR, DWORD, ULONG, USHORT, PGUID, NTSTATUS, NULL, LONG, UCHAR, PRPC_SID, \
    GUID, RPC_UNICODE_STRING, SECURITY_INFORMATION, LPULONG
from horizon3_impacket.impacket import system_errors, nt_errors
from horizon3_impacket.impacket.uuid import uuidtup_to_bin
from horizon3_impacket.impacket.dcerpc.v5.enum import Enum
from horizon3_impacket.impacket.dcerpc.v5.samr import OLD_LARGE_INTEGER
from horizon3_impacket.impacket.dcerpc.v5.lsad import PLSA_FOREST_TRUST_INFORMATION
...
from horizon3_impacket.impacket import ntlm, crypto, LOG
import hmac
import hashlib
try:
...
# 2.2.1.1.2 STRING
from horizon3_impacket.impacket.dcerpc.v5.lsad import STRING
...
from horizon3_impacket.impacket.dcerpc.v5.samr import SAMPR_LOGON_HOURS
