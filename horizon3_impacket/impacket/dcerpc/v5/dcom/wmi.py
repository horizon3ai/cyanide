...
from horizon3_impacket.impacket.dcerpc.v5.ndr import NDRSTRUCT, NDRUniConformantArray, NDRPOINTER, NDRUniConformantVaryingArray, NDRUNION, \
    NDRENUM
from horizon3_impacket.impacket.dcerpc.v5.dcomrt import DCOMCALL, DCOMANSWER, IRemUnknown, PMInterfacePointer, INTERFACE, \
    PMInterfacePointer_ARRAY, BYTE_ARRAY, PPMInterfacePointer, OBJREF_CUSTOM
from horizon3_impacket.impacket.dcerpc.v5.dcom.oaut import BSTR
from horizon3_impacket.impacket.dcerpc.v5.dtypes import ULONG, DWORD, NULL, LPWSTR, LONG, HRESULT, PGUID, LPCSTR, GUID
...
from horizon3_impacket.impacket import hresult_errors, LOG
from horizon3_impacket.impacket.uuid import string_to_bin, uuidtup_to_bin
from horizon3_impacket.impacket.structure import Structure, hexdump
