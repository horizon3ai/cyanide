...
from horizon3_impacket.impacket import smb, smb3, nmb, nt_errors, LOG
from horizon3_impacket.impacket.ntlm import compute_lmhash, compute_nthash
from horizon3_impacket.impacket.smb3structs import SMB2Packet, SMB2_DIALECT_002, SMB2_DIALECT_21, SMB2_DIALECT_30, GENERIC_ALL, FILE_SHARE_READ, \
...
class SMBConnection:
    ...
    def kerberosLogin(self, user, password, domain='', lmhash='', nthash='', aesKey='', kdcHost=None, TGT=None,
        ...
        from horizon3_impacket.impacket.krb5.kerberosv5 import KerberosError
