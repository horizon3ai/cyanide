...
from horizon3_impacket.impacket import nmb, ntlm, uuid, crypto
from horizon3_impacket.impacket.smb3structs import *
from horizon3_impacket.impacket.nt_errors import STATUS_SUCCESS, STATUS_MORE_PROCESSING_REQUIRED, STATUS_INVALID_PARAMETER, \
    STATUS_NO_MORE_FILES, STATUS_PENDING, STATUS_NOT_IMPLEMENTED, ERROR_MESSAGES
from horizon3_impacket.impacket.spnego import SPNEGO_NegTokenInit, TypesMech, SPNEGO_NegTokenResp, ASN1_OID, asn1encode, ASN1_AID
from horizon3_impacket.impacket.krb5.gssapi import KRB5_AP_REQ
...
class SMB3:
    ...
    def kerberosLogin(self, user, password, domain = '', lmhash = '', nthash = '', aesKey='', kdcHost = '', TGT=None, TGS=None, mutualAuth=False):
        ...
        from horizon3_impacket.impacket.krb5.asn1 import AP_REQ, Authenticator, TGS_REP, seq_set
        ...
        from horizon3_impacket.impacket.krb5.types import Principal, KerberosTime, Ticket
...
#            pass
        ...
        if mutualAuth == True:
            from horizon3_impacket.impacket.krb5.constants import APOptions
        ...
        if ans.isValidAnswer(STATUS_SUCCESS):
            ...
            if mutualAuth == True:
                ...
                from horizon3_impacket.impacket.krb5.asn1 import AP_REP, EncAPRepPart
    ...
    def listPath(self, shareName, path, password = None):
        ...
        try:
            ...
            res = ''
            files = []
            from horizon3_impacket.impacket import smb
            while True:
                try:
